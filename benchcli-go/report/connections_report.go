...
// connections at and answered each one's first request, which is what this
// benchmark measures. It has no CPU EER or MEM EER to break a tie with: the
// connection test samples no CPU or memory.
